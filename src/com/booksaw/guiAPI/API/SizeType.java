...
SMALLEST/** Used to make the gui as small as possible*/, LARGEST/** makes the gui size = Gui.MAXSIZE*/, BLANKROW /** Same as smallest but leaves a blank row at the bottom*/,CUSTOM/** Allows the dev to specify a custom size for the gui (Gui.size)*/;
