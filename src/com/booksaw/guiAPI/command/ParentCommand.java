...
public class ParentCommand extends SubCommand {
	 ...
	 *                incorrect command
	 */
	public ParentCommand(String command, ChatColor helpCommandColor, ChatColor helpDescriptionColor,
			JavaPlugin plugin) {
		this.command = command;
		subCommands.put("help", new HelpCommand(this, helpCommandColor, helpDescriptionColor, plugin));
	}
